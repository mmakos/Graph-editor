...
int main()
{
    ...
    test.clear();
    //1 -> 1 2 3 0 4 5
    std::vector< std::string > test = uI.m_graph.BFS( 1 );
    ...
    test.clear();
    //2 -> 2 3 0 4 1 5
    std::vector< std::string > test = uI.m_graph.BFS( 2 );
    ...
    test.clear();
    //3 -> 3 0 4 1 5 2
    std::vector< std::string > test = uI.m_graph.BFS( 3 );
    ...
    test.clear();
    //4 -> 4 1 5 2 3 0
    std::vector< std::string > test = uI.m_graph.BFS( 4 );
    ...
    test.clear();
    //5 -> 5
    std::vector< std::string > test = uI.m_graph.BFS( 5 );
    if( test[ 0 ] == "w5" )
        std::cout << "Wierzcholek startowy: 5 - test pomyslny." << std::endl;
    else
        std::cout << "Wierzcholek startowy: 5 - test negatywny." << std::endl;
    test.clear();
